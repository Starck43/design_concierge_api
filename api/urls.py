...
from .views import RateQuestionView, CategoryList, CategoryDetail, UserList, UserDetail
...
# users/<user_id>/ (GET, PUT, PATCH) - получение, обновление или частичное обновление данных пользователя telegram
